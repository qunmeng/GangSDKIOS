//
//  GangChatLeftVoiceTableViewCell.m
//  GangSDK
//
...
@implementation GangChatLeftLinkTableViewCell
...
- (void)awakeFromNib {
    ...
    self.label_title.textColor = [UIColor colorFromHexRGB:GangColor_gangChat_message_title_left];
    self.label_subTitle.textColor = [UIColor colorFromHexRGB:GangColor_gangChat_message_content_left];
}
