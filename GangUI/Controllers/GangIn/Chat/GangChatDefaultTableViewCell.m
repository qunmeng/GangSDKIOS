...
@implementation GangChatDefaultTableViewCell
...
-(void)setTheObj:(GangChatMessageBean*)obj{
    ...
    if (self.isSingle) {
        ...
        self.iv_bg.image = [UIImage imageNamed:@"qm_bg_gangchat_single_left"];
    }else{
        self.iv_bg.image = [UIImage imageNamed:@"qm_bg_gangchat_left"];
